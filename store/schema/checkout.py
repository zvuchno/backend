...
def checkout_schema(view_func):
    ...
    return extend_schema(
        ...
        description=(
            ...
            'сумму корзины, список доступных доставок и точки самовывоза '
            'у артиста.\n\n'
            'Особенность: если в корзине физические позиции от нескольких '
            'артистов - точки самовывоза артиста не возвращаются.',
        ),
        responses={
