...
class TestCatalogVisibility:
    """Тесты видимости товаров в каталоге."""

    def test_catalog_returns_only_public_products(
        self,
        api_client,
        catalog_url,
    ):
...
class TestCatalogCardValues:
    ...
    def test_catalog_album_card_has_expected_values(
        self,
        api_client,
        catalog_url,
    ):
    ...
    def test_catalog_merch_card_has_expected_values(
        self,
        api_client,
        catalog_url,
    ):
    ...
    def test_catalog_carrier_card_has_expected_values(
        self,
        api_client,
        catalog_url,
    ):
...
class TestCatalogTypeFilter:
    """Тесты фильтрации каталога по типу товара."""

    def test_catalog_filters_album_products(self, api_client, catalog_url):
    ...
    def test_catalog_filters_merch_products(self, api_client, catalog_url):
    ...
    def test_catalog_returns_all_product_types_by_default(
        self,
        api_client,
        catalog_url,
    ):
...
class TestCatalogGenreFilter:
    """Тесты фильтрации каталога по жанрам."""

    def test_catalog_filters_by_genre(self, api_client, catalog_url):
    ...
    def test_catalog_filters_by_multiple_genres(self, api_client, catalog_url):
...
class TestCatalogKindFilter:
    """Тесты фильтрации каталога по видам мерча."""

    def test_catalog_filters_all_products_by_kind(
        self,
        api_client,
        catalog_url,
    ):
    ...
    def test_catalog_filters_carriers_by_kind(self, api_client, catalog_url):
    ...
    def test_catalog_filters_by_multiple_kinds(self, api_client, catalog_url):
...
class TestCatalogArtistFilter:
    """Тесты фильтрации каталога по артисту."""
...
class TestCatalogOrdering:
    """Тесты сортировки каталога."""

    def test_catalog_orders_by_created_at(self, api_client, catalog_url):
    ...
    def test_catalog_orders_by_created_at_desc(self, api_client, catalog_url):
