...
Модуль содержит общий сериализатор, который расширяет
стандартную логику регистрации пользователя и позволяет
обрабатывать дополнительные поля, не входящие в модель пользователя.
"""
