...
FRONTEND_ARTIST_CLAIM_PATH = os.getenv('FRONTEND_ARTIST_CLAIM_PATH', '/artist-claim')

INVITATION_TTL_DAYS = int(os.getenv('INVITATION_TTL_DAYS', 7))
INVITATION_RESEND_COOLDOWN_SECONDS = int(
    os.getenv('INVITATION_RESEND_COOLDOWN_SECONDS', 600),
)
...
DEFAULT_FIAS = os.getenv('DEFAULT_FIAS')
GEO_PROVIDER = os.getenv('GEO_PROVIDER')
TARIFF_OFFICE=os.getenv('TARIFF_OFFICE')
TARIFF_DOOR=os.getenv('TARIFF_DOOR')
TARIFF_PICKUP=os.getenv('TARIFF_PICKUP')
